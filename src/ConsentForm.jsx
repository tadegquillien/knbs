...
const ConsentForm = ({ setPhase }) => {
    return (
        <div style={consentStyle}>
            ...
            <p>The researchers are from the Informatics and Psychology department at the University of Edinburgh: Christopher G. Lucas, Neil Bramley and Tadeg Quillien.</p>

            <h2>What is the purpose of the study?</h2>
            <p>The purpose of this study is to understand how people make judgments about what other people know and believe.</p>
            ...
            <p>You are invited to participate in an online study that involves observing, interacting with, and making judgments about simple stimuli on a web-based interface. Once you finish, we may have some questions about your experience (e.g., age, gender, feedback about how you approached the task). Your responses will be recorded.
                ...
                We estimate that the study session will last about 10 minutes. You will be given full instructions shortly.</p>
